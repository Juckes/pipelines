...
def azure_client():
    ...
    subscription_id = '13e1ebd2-b4ab-48f5-ba4e-73d8e2db4f85'  # Replace with your actual subscription ID
    return ResourceManagementClient(credential, subscription_id)

def test_resource_group_exists(azure_client):
    rg_name = 'tfstate-tfdemo-rg'  # Replace with your actual resource group name
